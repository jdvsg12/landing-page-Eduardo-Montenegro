...
function CategoryTab({
    ...
    return (
        <button
            ...
            className={`relative cursor-pointer px-6 py-3 text-left text-lg font-medium transition-colors lg:text-xl ${isActive
                ? "text-foreground"
    ...
    return (
        <section id="faq" className="relative scroll-mt-20 bg-paper py-24 lg:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <h2 className="mb-16 font-serif text-4xl italic text-foreground lg:mb-20 lg:text-6xl">
                    {faqContent.title}
                </h2>
