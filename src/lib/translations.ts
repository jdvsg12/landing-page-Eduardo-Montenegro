...
export const translations = {
    es: {
        ...
        services: {
            ...
            detailWhatsAppTitle: "¿Te interesa este servicio?",
            detailWhatsAppSubtitle: "Escríbeme por WhatsApp para más información o para agendar.",
            detailFormTitle: "Reserva tu lugar",
            detailFormSubtitle: "Déjame tus datos y me pongo en contacto contigo.",
            detailFormSubmit: "Enviar inscripción",
    ...
    en: {
        ...
        services: {
            ...
            detailWhatsAppTitle: "Interested in this service?",
            detailWhatsAppSubtitle: "Message me on WhatsApp for more information or to book a session.",
            detailFormTitle: "Reserve your place",
            detailFormSubtitle: "Leave me your details and I will get in touch with you.",
            detailFormSubmit: "Send registration",
    ...
    fr: {
        ...
        services: {
            ...
            detailWhatsAppTitle: "Ce service vous intéresse ?",
            detailWhatsAppSubtitle: "Écrivez-moi sur WhatsApp pour plus d'informations ou pour prendre rendez-vous.",
            detailFormTitle: "Réservez votre place",
            detailFormSubtitle: "Laissez-moi vos coordonnées et je vous recontacte.",
            detailFormSubmit: "Envoyer l'inscription",
